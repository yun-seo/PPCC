...
import open3d
import torch
from extensions.chamfer_dist import ChamferDistanceL1, ChamferDistanceL2, PatialChamferDistanceL2, PatialChamferDistanceL1
...
class Metrics(object):
    ...
    }, 
    {
        'name': 'UCDL1',
        'enabled': True,
        'eval_func': 'cls._get_unidirectional_chamfer_distancel1',
        'eval_object': PatialChamferDistanceL1(ignore_zeros=True),
    ...
    @classmethod
    def _get_f_score(cls, pred, gt, th=0.1):
    ...
    def _get_chamfer_distancel1(cls, pred, gt):
        ...
        return chamfer_distance(pred, gt) * 100
    ...
    @classmethod
    def _get_unidirectional_chamfer_distancel1(cls, pred, gt):
        # chamfer_distance = cls.ITEMS[4]['eval_object']
        chamfer_distance = cls.ITEMS[1]['eval_object']
        return chamfer_distance(gt, pred) * 100

    @classmethod
    def _get_unidirectional_chamfer_distancel2(cls, pred, gt):
        # chamfer_distance = cls.ITEMS[5]['eval_object']
